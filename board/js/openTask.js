  ...
  return /*html*/`
        <div class="left-side">
          ...
          <div class="assigned-contact board-task-input">
              <p>Assigned to</p>
              <input type="button" value="Select contacts to assign" id="">
          </div>
...
function generateHTMLCategory() {
  return /*html*/`
    <div class="category board-task-input">
...
function generateHTMLSubtask() {
  return /*html*/`
    <div class=" subtasks board-task-input">
      <p>Subtasks</p>
  ...
  return /*html*/`
      <div class="bottom-button">
        <button class="cancel-button">
          <span>Cancel</span>
          <img src="/assets/img/cancel.png" alt="cancel Button in add task">
        </button>
